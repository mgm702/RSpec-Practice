...
seconds_in_year = (52 * days_in_a_week * (seconds_in_an_hour * hours_in_a_day))
turn_twenty_age_in_seconds = 20 * seconds_in_year
turn_one_hundred_age_in_seconds = 100 * seconds_in_year
...
puts 'That means when you turn 20, you\'ve been alive'\
  " for #{turn_twenty_age_in_seconds} seconds,"
puts 'and if you make it to 100, you will have'\
  " lived #{turn_one_hundred_age_in_seconds} seconds. Make them count!"
